...
def main():
    ...
    print("""
  ######################################
  # TIL Development Environment Setup #
  ######################################

  This script will create your TIL dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your TIL project folder:
    [Arma 3 installation directory]\\{} => TIL project folder
    P:\\{}                              => TIL project folder
